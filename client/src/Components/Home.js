            ...
            <div class="card h-100">
              <div class="card-body">
                ...
                <p class="card-text">
                  ...
                  Voluptas deleniti, harum, magnam perspiciatis quae saepe
                  obcaecati nesciunt tempora atque veniam culpa voluptates
                  debitis impedit animi a eum ad quam autem, laboriosam ratione
                  labore ab. At facilis illo ad blanditiis delectus eaque
                  minima, molestiae rerum, quidem nostrum, iste ex provident!
                  Maxime!
                </p>
              </div>
          ...
          <div class="col">
            <div class="card h-100">
              <div class="card-body">
                ...
                <p class="card-text">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit.
                  Accusantium, illo dicta? Soluta, odit nam quaerat provident
                  veniam minima accusantium facere molestiae in, dolorum rem
                  reiciendis.
                </p>
              </div>
              <div className="card-footer">
          ...
          <div class="col">
            <div class="card h-100">
              <div class="card-body">
                ...
                <p class="card-text">
                  Lorem ipsum dolor, sit amet consectetur adipisicing elit.
                  Eligendi, perferendis! Minus tempore et possimus, quasi dicta
                  ullam sequi dolor, voluptatibus hic soluta praesentium odit!
                  Id quae labore quisquam quis iure?
                </p>
              </div>
              <div className="card-footer">
                <a href="#" class="btn btn-primary">
